...
<div class="bg-air py-10 lg:py-16">
			...
			<div class="w-full lg:w-[504px] lg:shrink-0">
				...
				<div class="flex flex-col gap-8" data-stagger="true">
					<?php foreach ( $cards as $card ) : ?>
						...
						<!-- Outer card -->
						<div class="flex flex-col gap-2 rounded-container-md bg-[#fff] p-4 shadow-sm">
							...
							<!-- Inner content card -->
							<div class="flex flex-col gap-4 rounded-container-md bg-[#fff] px-4 py-6 shadow-sm">
								...
								<?php if ( ! empty( $card_benefits ) ) : ?>
									...
									<div class="flex flex-col gap-4 rounded-container-md bg-forest px-4 pb-5 pt-4">
										...
										<div class="flex items-center gap-4">
											...
											<div class="flex-1 h-px" style="background-color: <?php echo $check_color ? esc_attr( $check_color ) : '#4C9F38'; ?>"></div>
										</div>
