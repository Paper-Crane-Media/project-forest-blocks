...
<?php if ( 'image-grid' === $variant ) : ?>
	...
	<div class="bg-forest overflow-hidden">
		<div class="flex flex-col lg:flex-row lg:items-center">
			...
			<!-- Content (left) -->
			<div data-stagger="true" class="flex flex-1 flex-col items-start gap-4 p-8 lg:pl-16 lg:pr-10">
				...
				<?php if ( $content ) : ?>
					<div class="wysiwyg text-display-sm font-body text-[#fff]">
			...
			<?php if ( count( $gallery ) >= 4 ) : ?>
				<div class="flex-1 p-8">
					<div class="grid grid-cols-2 grid-rows-12 gap-1 h-[33.5rem]">
						<div class="relative col-start-1 row-start-1 row-end-5 overflow-hidden rounded-container-md">
...
<?php elseif ( 'white-centered' === $variant ) : ?>
	<!-- White Centered variant -->
	<div class="bg-air px-8 py-16 rounded-container-md">
		<div class="mx-auto w-[94%] max-w-container">
			<div data-stagger="true" class="flex flex-col items-center gap-10">

				<?php if ( $title ) : ?>
					<h4 class="text-display-md font-heading font-semibold text-forest text-center">
						<?php echo esc_html( $title ); ?>
					</h4>
				<?php endif; ?>

				<?php echo fb_button( $link ?: [], 'Reach out' ); ?>
